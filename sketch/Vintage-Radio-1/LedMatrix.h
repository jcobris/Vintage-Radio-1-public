...
#include <Arduino.h>
#include <FastLED.h>
#include "Config.h"  // <-- use Config as single source of truth

namespace LedMatrix {

  // ================== Hardware & global settings ==================
  // Use Config.h for pinout (single source of truth)
  static const uint8_t DATA_PIN = Config::PIN_MATRIX_DATA; // WS2812B DIN
